...
//     }
 ...
 //   **** Part 3: Feeling Loopy***************/
    ...
    const csvString = "ID,Name,Occupation,Age,42,Bruce,Knight,41,57,Bob,Fry ,Cook,19,63,Blaine,Quiz, Master,58,98,Bill,Doctor ,Assistant,26 " 

    const colors=csvString.split(",")
